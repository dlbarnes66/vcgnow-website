...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InR5eGRkeGhteXF4cGl3aGVmdHlhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mzc4MTA2MTcsImV4cCI6MjA1MzM4NjYxN30.QlY7v25mQC-lNUW0lR8fwNUkX6YWWcDGQkJOyAyMg7c';

// Initialize Supabase client (renamed to avoid conflict)
const vcgClient = window.supabase.createClient(SUPABASE_URL, SUPABASE_ANON_KEY);
        ...
        contactForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                const investorData = {
                    ...
                    tags: ['Contact Form', 'vcgnow.com', new Date().toISOString().split('T')[0]],
                    created_at: new Date().toISOString(),
                    last_contact_date: new Date().toISOString().split('T')[0]
                };
                
                // Insert into Supabase
                const { data, error } = await vcgClient
                    .from('investors')
                    .insert([investorData])
                    .select();
...
console.log('Supabase Connection:', vcgClient ? 'Initialized' : 'Failed');
